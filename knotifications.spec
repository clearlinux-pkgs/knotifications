...
Source0  : https://download.kde.org/stable/frameworks/5.91/knotifications-5.91.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.91/knotifications-5.91.0.tar.xz.sig
...
%prep
%setup -q -n knotifications-5.91.0
cd %{_builddir}/knotifications-5.91.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644799461
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knotifications-5.91.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/knotifications/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/knotifications-5.91.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/knotifications/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/knotifications-5.91.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/knotifications/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/knotifications-5.91.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/knotifications/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/knotifications-5.91.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/knotifications/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/knotifications-5.91.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/knotifications/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/knotifications-5.91.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/knotifications/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/knotifications-5.91.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/knotifications/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/knotifications-5.91.0/docs/qml-notification.md.license %{buildroot}/usr/share/package-licenses/knotifications/28ba3ebe1aa04fad742c69eb685e2a5376e9276f
cp %{_builddir}/knotifications-5.91.0/src/qml/qmldir.license %{buildroot}/usr/share/package-licenses/knotifications/28ba3ebe1aa04fad742c69eb685e2a5376e9276f
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Notifications.so.5.91.0
