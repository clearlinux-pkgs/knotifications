...
Source0  : https://download.kde.org/stable/frameworks/5.64/knotifications-5.64.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.64/knotifications-5.64.0.tar.xz.sig
...
%prep
%setup -q -n knotifications-5.64.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573402273
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/knotifications-5.64.0/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/knotifications/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/knotifications-5.64.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/knotifications/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Notifications.so.5.64.0
