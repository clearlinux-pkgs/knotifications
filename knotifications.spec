...
Source0  : https://download.kde.org/stable/frameworks/5.98/knotifications-5.98.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.98/knotifications-5.98.0.tar.xz.sig
...
%prep
%setup -q -n knotifications-5.98.0
cd %{_builddir}/knotifications-5.98.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662944547
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Notifications.so.5.98.0
