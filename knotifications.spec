...
Source0  : https://download.kde.org/stable/frameworks/5.53/knotifications-5.53.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.53/knotifications-5.53.0.tar.xz.sig
...
%prep
%setup -q -n knotifications-5.53.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1544488911
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/share/xdg/knotifications.categories
...
/usr/lib64/libKF5Notifications.so.5.53.0
