...
Source0  : https://download.kde.org/stable/frameworks/5.99/knotifications-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/knotifications-5.99.0.tar.xz.sig
...
%prep
%setup -q -n knotifications-5.99.0
cd %{_builddir}/knotifications-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665417754
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Notifications.so.5.99.0
